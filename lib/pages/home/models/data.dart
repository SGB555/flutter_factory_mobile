class Data {
	...
	@override
	String toString() {
		return 'Data(id: $id, loginName: $loginName, userName: $userName, type: $type, phone: $phone, name: $name, email: $email, lastLoginFactoryId: $lastLoginFactoryId, headImg: $headImg, bossUnitId: $bossUnitId)';
	}
